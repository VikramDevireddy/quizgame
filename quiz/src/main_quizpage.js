...
import Cmeimg from "./cme.png"


const Quizgame=()=>{
const questions_cme_1=[
    {
        questionValue:"what is css full form?",
        options:[
    ...
    {
        questionValue:"what is html full form?",
        options:[
        ...
        questionValue:"what is asap full form?",
        options:[
...
const startgame=()=>{
    ...
    return(
        <div>
            <img src={Cmeimg} alt="cme" id="branchimg"/>
